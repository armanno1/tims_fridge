    ...
    <>
      <div className="container">
        ...
        <div style={{textAlign: 'center', padding: '10px 0 0 0'}}>
          {isSignedIn ? <div style={{display: 'inline-block', color: 'white', fontWeight: 'bold', cursor: 'pointer', backgroundColor: 'rgba(0, 98, 102,1.0)', padding: '8px 18px', borderRadius: '5px', border: '1px solid rgba(245, 246, 250, 0.3)'}} onClick={showDash}>Open Dashboard! ⚡</div> : <div style={{color: 'white', fontSize: ".9em", fontWeight: 'normal'}}>Own this fridge? <span onClick={() => setShowLoginModal(true)} style={{cursor: 'pointer', fontWeight: 'bold'}}>Login</span></div> }
